...
START_IMG = environ.get('START_IMG', 'https://telegra.ph/Dm-07-08-5')
...
SHORTENER_API = environ.get("SHORTENER_API", "770a5e2a9d237d2124f3bbd50a5927c1497a9dab")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'inshorturl.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "57aaaed424de99b223fb3dab66e4aa932d5a7d8a")
...
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "86100"))
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002167069112'))
...
#If you want MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002222628655'))
