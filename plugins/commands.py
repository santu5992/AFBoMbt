...
async def start(client:Client, message): 
    ...
    if not await db.is_user_exist(message.from_user.id):
        ...
        try: 
            ...
            if refData and refData.split("-", 1)[0] == "ReferID":
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="<b>⚠️First Click On 'ᴊᴏɪɴ ɴᴏᴡ' Button & Join,\n\n😊Then Click On 'ᴛʀʏ ᴀɢᴀɪɴ' Button To Get Your File.</b>",
            reply_markup=InlineKeyboardMarkup(btn),
            parse_mode=enums.ParseMode.HTML
        )
        return
    ...
    if data and data.startswith("allfiles"):
        ...
        delCap = "<b>❗️❗️❗️WARNING!❗️❗️❗️\n\nᴀʟʟ {} ғɪʟᴇs ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs!\n\n📌 PLEASE FORWARD THIS FILE TO SOMEWHERE ELSE AND START DOWNLOADING THERE</b>".format(len(files_to_delete), f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
    ...
    delCap = "<b>❗️❗️❗️WARNING!❗️❗️❗️\n\nᴛʜɪs ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ ᴀꜰᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs!\n\n📌 PLEASE FORWARD THIS FILE TO SOMEWHERE ELSE AND START DOWNLOADING THERE</b>".format(f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
...
async def settings(client, message):
    ...
    user_id = message.from_user.id if ADMINS else None
    if not user_id:
